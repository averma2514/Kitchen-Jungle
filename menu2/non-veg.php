  ...
  <header class="header">
    ...
    <nav class="navbar navbar-dark bg-dark" style = 'height: 100px'>
        <div class="container-fluid">
          <h2  style = 'color: white'>Kitchen Jungle Non-Vegetarian Menu</h2>
      ...
      <div class = 'container'>
        <div class = 'row'>
          <?php
            ...
            $menulistqry="SELECT * FROM `menu` where Categories = 'non-veg'";
    ...
    <a type="button" href="..\payment\payment.php" class="submit-btn"><center class="text">PROCEED TO PAY</center></button>
