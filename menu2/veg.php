...
<body>
  <header class="header">
    ...
    <?php require_once 'script.php'; ?>
      ...
      <form  id="login" action="order.php" method="POST" class="">
          <input type="hidden" name="hidden_grand" class="hidden_grand">
          <input type="hidden" name="password_login" class="input-field">
         
          <button type="submit" class="submit-btn">PLACE ORDER</button>
      </form>
<!-- <?php 
$grand = $_POST['hidden_grand'];
echo $grand;
?> -->
